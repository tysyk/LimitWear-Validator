...
VISUAL_LOGO_FRAGMENT_REVIEW_COUNT = 3
VISUAL_LOGO_NO_BRAND_CONFIDENCE = 0.95
...
BRAND_SUSPECTED_FALLBACK_THRESHOLD = 0.58
BRAND_SUSPECTED_MAX_AREA_RATIO = 0.08
BRAND_SUSPECTED_MIN_MARGIN = 0.15
